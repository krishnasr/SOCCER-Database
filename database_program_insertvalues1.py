...
try:
    ...
    if connet.is_connected():
        ...
        cursor.execute("CREATE TABLE MATCH_RESULTS ( Match_id INT NOT NULL, Date_of_Match DATE, Start_Time_Of_Match TIME, Team1 VARCHAR(20), Team2 VARCHAR(20), Team1_score INT, Team2_score INT, Stadium_Name VARCHAR(35), Hosty_City VARCHAR(20), PRIMARY KEY (Match_id), FOREIGN KEY (Team1) REFERENCES COUNTRY ( Country_Name) , FOREIGN KEY (Team2) REFERENCES COUNTRY ( Country_Name) );")
        ...
        cursor.execute("CREATE TABLE PLAYER_CARDS ( Player_id INT NOT NULL, Yellow_Cards INT, Red_Cards INT, PRIMARY KEY ( Player_id),FOREIGN KEY (Player_id) REFERENCES PLAYERS(Player_id) );")
        ...
        cursor.execute("CREATE TABLE PLAYER_ASSISTS_GOALS ( Player_id INT NOT NULL, No_of_Matches INT, Goals INT, Assists INT, Minutes_Played INT, PRIMARY KEY (Player_id), FOREIGN KEY (Player_id) REFERENCES PLAYERS(Player_id) );")
